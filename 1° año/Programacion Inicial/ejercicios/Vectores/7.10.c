/******************************************************************************************************
Se procesan los datos de los casi 90 alumnos de un turno de la materia Elementos de Programacion.
...
Se pide informar con las leyendas aclaratorias y/o titulos:
    a. Segun los parciales si promociono, aprobo, reprobo o estuvo ausente (uno o ambos parciales igual
    a cero).
    b. Listar los alumnos que no cumplen con la asistencia (mayor o igual a 75%).
    c. Informar cuantos alumnos que promocionaron NO cumplen en la asistencia.
